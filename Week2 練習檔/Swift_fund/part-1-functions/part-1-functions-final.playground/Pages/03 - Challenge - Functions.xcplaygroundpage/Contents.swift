...
//The exclamation mark (!) is used to force-unwrap this optional value, indicating that you are certain the array is not empty and that a non-nil value will be returned.
